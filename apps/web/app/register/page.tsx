      ...
      <div className="w-full max-w-md">
        <ClayCard className="!p-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-extrabold text-gray-900 mb-2">Join the Arena</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                type="text"
                required
                className="w-full px-4 py-3 rounded-xl bg-white/50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-indigo"
                value={formData.name}
            ...
            <ClayButton type="submit" variant="primary" className="w-full mt-6" disabled={loading}>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#F8F7FF] text-gray-500 font-medium">Or continue with</span>
              </div>
            </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <button onClick={() => signIn()} className="text-primary-indigo font-bold hover:underline">
              Sign In
            </button>
          </p>
        </ClayCard>
